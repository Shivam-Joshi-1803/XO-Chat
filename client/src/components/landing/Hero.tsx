        ...
        <div className="col-span-4 md:col-span-7 flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 xs:gap-4">
            <button
              ...
              aria-label="Create Identity and start chatting"
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-border px-4 py-3 bg-surface gap-2">
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    aria-label="View Chat simulation"
                  ...
                  <button
                    ...
                    aria-label="View Requests simulation"
                    className={`px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest transition-all cursor-pointer rounded-none border ${
                  ...
                  <button
                    ...
                    aria-label="View Recovery simulation"
                    className={`px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest transition-all cursor-pointer rounded-none border ${
                  ...
                  <div className="w-full space-y-3 text-left">
                    <div className="p-3 border border-border bg-subtle-gray flex items-center justify-between rounded-none">
                      ...
                      <div className="flex gap-1.5">
                        <button aria-label="Accept Alice request simulation" className="px-2 py-1 bg-foreground text-background text-[9px] font-black uppercase tracking-widest rounded-none border border-border hover:bg-[#FF4F00] hover:border-[#FF4F00] hover:text-white transition-colors cursor-pointer">Accept</button>
                        <button aria-label="Ignore Alice request simulation" className="px-2 py-1 bg-surface text-foreground text-[9px] font-bold uppercase tracking-widest rounded-none border border-border hover:bg-foreground hover:text-background transition-colors cursor-pointer">Ignore</button>
                      </div>
                    </div>
